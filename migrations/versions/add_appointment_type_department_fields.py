...
Revision ID: add_appointment_type_department
...
revision: str = 'add_appointment_type_department'
down_revision: Union[str, Sequence[str], None] = ('restructure_appointments', '2091a86885bd')
